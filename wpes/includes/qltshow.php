            ...
            <div class="container-fluid">
                ...
                <table class="table table-striped">
                    <thead class="text-center">
                        ...
                        <th class="text-center" colspan="3" width="100">الإستجابة</th>
                ...
                while($row2=mysql_fetch_array($statment2)){
                    ...
                    echo("<tr>
                         ...
                         <td width='102'><img class='img1' src='img/upload.png' onclick='openWin1(".$row2['id'].",1)' >
